...
import com.weather.Models.ImageHandler;
import com.weather.Models.WeatherManager;
...
public class Controller implements Initializable {
    ...
    private Label city, temperature, day, desc, errors, windSpeed, cloudiness, pressure, humidity,
            tempMon, tempTue, tempWed, tempThu, tempFri, tempSat, tempSun;

    //Constructor to set the initial city to Addis Ababa
    public Controller() {
        this.citySet = "Addis Ababa";
    }
    ...
    private void showWeather(){
        ...
        tempMon.setText(weatherManager.getTempMon().toString()+"°C");
        tempTue.setText(weatherManager.getTempTue().toString()+"°C");
        tempWed.setText(weatherManager.getTempWed().toString()+"°C");
        tempThu.setText(weatherManager.getTempThu().toString()+"°C");
        tempFri.setText(weatherManager.getTempFri().toString()+"°C");
        tempSat.setText(weatherManager.getTempSat().toString()+"°C");
        tempSun.setText(weatherManager.getTempSun().toString()+"°C");
